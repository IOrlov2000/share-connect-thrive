    ...
    <div className="container px-4 py-6 space-y-8">
      ...
      >
        ...
        <h1 className="font-display text-2xl sm:text-4xl md:text-5xl font-bold leading-tight">
          <span className="inline-block animate-[fade-in_0.6s_ease-out_0.1s_both]">Здесь Вы Можете Обменять</span>{" "}
          <span className="text-gradient inline-block animate-[fade-in_0.8s_ease-out_0.4s_both] hover:scale-105 transition-transform duration-300 cursor-default">Всё</span>
          <span className="inline-block animate-[fade-in_0.9s_ease-out_0.6s_both]">, и даже свою</span>{" "}
          <span className="text-gradient inline-block animate-[fade-in_1s_ease-out_0.8s_both] hover:scale-105 transition-transform duration-300 cursor-default">Локацию</span>
        </h1>
